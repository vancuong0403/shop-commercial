                  ...
                  <div className="product-image-wrapper">
                    <div className="single-products">
                      <div className="productinfo text-center" id="product1">
                        ...
                        <a href="#" className="btn btn-default add-to-cart" value><i className="fa fa-shopping-cart" />Add to cart</a>
                      </div>
                      ...
                      <div className="product-image-wrapper">
                        <div className="single-products">
                          <div className="productinfo text-center">
                            ...
                            <h2>$56</h2>
                            <p>Easy Polo Black Edition</p>
                            <a href="#" className="btn btn-default add-to-cart" val><i className="fa fa-shopping-cart" />Add to cart</a>
                          </div>
                        </div>
                      </div>
                    </div>
